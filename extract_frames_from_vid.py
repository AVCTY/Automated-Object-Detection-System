...
video_folder = "../Dataset/To extract/20201113_new" #change your folder containing videos here
...
for video in video_files:
    ...
    while success:
        ...
        cv2.imwrite(f"extracted/{filename}_frame{count}.jpg", image)     # save frame as JPEG file      
        success,image = vidcap.read()
